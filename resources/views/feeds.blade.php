            ...
            <div class="report-modal-body">
                <form id="reportForm">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="reportReason" id="reportReason" placeholder="Tell us why you're reporting this post..."
                    ...
                    <div class="screenshot-upload-section">
                        ...
                        <input type="file" id="screenshotInput" class="file-input" name="screenshot"
                            accept="image/*" hidden>
