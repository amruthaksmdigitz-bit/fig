                ...
                <nav class="mt-2">
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('admin.page.create', ['slug' => 'howitworksdescription']) }}"
                                        class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Create</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.page.index', ['slug' => 'howitworksdescription']) }}"
                                        class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>List</p>
                                    </a>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('admin.page.create', ['slug' => 'howitworks']) }}"
                                        class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Create</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.page.index', ['slug' => 'howitworks']) }}"
                                        class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>List</p>
                                    </a>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('admin.page.create', ['slug' => 'profiledescription']) }}"
                                        class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Create</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.page.index', ['slug' => 'profiledescription']) }}"
                                        class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>List</p>
                                    </a>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('admin.page.create', ['slug' => 'createaccountdescription']) }}"
                                        class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Create</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.page.index', ['slug' => 'createaccountdescription']) }}"
                                        class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>List</p>
                                    </a>
