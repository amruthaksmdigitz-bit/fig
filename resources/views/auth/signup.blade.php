            ...
            <div class="signup-box">
                ...
                <form action="{{ route('signup.post') }}" method="POST" id="signupForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tel" name="phone_no" value="{{ old('phone_no') }}" class="form-control @error('phone_no') is-invalid @enderror"
                            required maxlength="10" minlength="10" pattern="[0-9]{10}" placeholder="Enter 10-digit mobile number">
                        @error('phone_no')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="text-white-50" style="font-size: 12px; display: block; margin-top: 4px;">Enter 10-digit mobile number without country code</small>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Location</label>
                        <select name="location" class="form-control @error('location') is-invalid @enderror"
                            id="homelocation" required>
